...
import { BASE_GOERLI_ENTRYPOINT_ADDRESS, PRE_VERIFICATION_GAS_BUFFER, VERIFICATION_GAS_LIMIT_BUFFER } from './constants'
 ...
 * hexadecimal string.
 */
const formatAsHex = (value: undefined | string | Uint8Array | bigint | number): `0x${string}` | undefined => {
  if (value === undefined) {
    return value
